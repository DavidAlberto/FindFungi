...
##### USER INPUT REQUIRED:
ScriptPath=/media/strain/datos/AaronDavid/Scripts  #Location of downloaded python and shell scripts
PreDir=/media/strain/datos/AaronDavid/Datos/Prueba/ResultsKraken/$z  #Location you want FindFungi to build the analysis
KrakenDir=/media/strain/datos/AaronDavid/Database/Kraken_32DB  #Location of the 32 downloaded Kraken databases
FungTaxDir=/media/strain/datos/AaronDavid/TaxIDs  #Location of the Fungal taxids and PipelineSummary files from GitHub
BLAST_DB_Dir=/media/strain/datos/AaronDavid/Database/FungalGenomeDatabases_EqualContigs  #Location of the 949 downloaded BLAST databases
#####
...
for i in $(seq 1 32); do
	/media/strain/datos/AaronDavid/bin/kraken  --db $KrakenDir/Kraken_$i --threads 8 --fasta-input $PreDir/FASTA/$z.final.fna --output $Dir/Processing/SplitFiles_Kraken/$z.$i
done	
wait
